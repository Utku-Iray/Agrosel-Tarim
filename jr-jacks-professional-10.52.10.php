                ...
                <div class="service-sidebar__links">
                        <ul>
                            ...
                            <div id="in16" class="collapse">
                                <ul>
                                    <li  style="background-color: #e3e3e3;"><a href="jr-jacks-professional-10.52.10.php">Jack's Professional 10.52.10+ME</a></li>
                    ...
                    <div>
                        <a target="_blank" href="assets/images/pdf/neovent-20-etiket.pdf"> <img src="assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black">Jack's Prof. 10-52-10 Etiket</span> </a>
                    </div>
                    <br>
                    <div>
                        <a target="_blank" href="assets/images/pdf/neovent-20-tescil.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black">Jack's Prof. 10-52-10 Tescil</span></a>
                    </div>
                </div><!-- /.service-sidebar -->
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-8">
                ...
                <table class="table" style="margin-top: 20px;">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row">1</th>
                            <td> 10.52.10 + ME</td>
                            <td> Plant Starter 77780T</td>
                            <td> Bitki doku gelişimini teşvik ederek, kök ve tomurcuk oluşumuna yardımcı olur. </td>
