...
<head>
    ...
    <title>Terrafert Glymax - Pro | Hayvansal Menşeli Aminoasitli Organik Gübre | Agrosel Tarım </title>
    <!-- favicons Icons -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <h3 style="margin-top: 0px;">Hayvansal Menşeli Aminoasitli Organik Gübre</h3>
                <p>içerisinde bulunan yüksek oranda serbest aminoasitler ile, bitkilerin aminoasit dengesini korur ve stres koşullarına karşı dayanıklılığını arttırarak; vejetatif ve generatif gelişiminin en iyi şekilde gerçekleşmesini sağlar. Ayrıca; bitkilerin dikimden hasada kadar ki, tüm gelişme dönemlerinde gerçekleşen kök oluşumu, çiçek oluşumu, sürgün gelişimi vb. aktiviteler de aktif rol oynayarak ürünün kalitesini ve verimini artırır.
                </p>
                <hr>
                <a href="#myModal" data-toggle="modal" data-target="#myModal"><img src="assets/images/glymax-kullanim-alani-1.jpeg" alt=""></a>

                <div id="myModal" class="modal fade" tabindex="-1" role="dialog">
                    <div class="modal-dialog" style="max-width:1000px !important">
                        <div class="modal-content">
                            <div class="modal-body">
                                <img src="assets/images/glymax-kullanim-alani-1.jpeg" class="img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
                <hr>
                <a href="#myModal2" data-toggle="modal" data-target="#myModal2"><img src="assets/images/glymax-kullanim-alani-2.jpeg" alt=""></a>

                <div id="myModal2" class="modal fade" tabindex="-1" role="dialog">
                    <div class="modal-dialog" style="max-width:1000px !important">
                        <div class="modal-content">
                            <div class="modal-body">
                                <img src="assets/images/glymax-kullanim-alani-2.jpeg" class="img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <hr>
                <h5 style="margin-top: 20px;">Terrafert Glymax - Pro Ambalaj:</h5>
                <div>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="assets/images/pdf/terrafert-glymax-pro-etiket.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> Glymax Etiket</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="assets/images/pdf/terrafert-glymax-pro-tescil.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Glymax Tescil</span></a>
                        </div>
                    </div>
                </div>
