...
<section class="service-details">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                <h2 style="margin-top: 0px;">Terrafert ACF 18-18-18 + TE</h2>
                ...
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        <li>
                            ...
                            <span style="font-weight: bold;">Terrafert 18.18.18+TE; kuru kristal şeklinde, suda çabuk ve tamamen eriyen bir gübredir. Eşit oranlarda Azot (N), Fosfor (P) ve Potasyum (K)’un yanı sıra bitkilerin en çok istedikleri mikro elementleri içerir.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">Terrafert 18.18.18+TE azot kaynağı Amonyum ve Nitrat’tan oluşur. (Üresizdir.)</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">Terrafert 18.18.18+TE’ nin içerisindeki mikro elementler şelatlanmıştır.  Böylece yıkanmaz ve fiske olmadığından her zaman bitkiler için alınabilir formdadır.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
