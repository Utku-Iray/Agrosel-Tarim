    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <hr>
                <a href="#myModal"data-toggle="modal" data-target="#myModal"><img src="assets/images/GROSE-MiX-kullanim.jpg" alt=""></a>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="assets/images/pdf/CARBO CAL-ETiKET.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Grose - Mix Etiket</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="assets/images/pdf/CARBO-CAL-TESCiL.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Grose - Mix Tescil</span></a>
                        </div>
                    </div>
                </div>
