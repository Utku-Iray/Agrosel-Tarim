                    ...
                    <div class="service-sidebar__links">
                        <ul>
                           ...
                           <li><a id="product3" href="#in14" data-toggle="collapse" style="color: #ffffff;background-color:#255946;font-weight:bold">Damla Sulama Gübreleri</a></li>
                            ...
                            <li><a id="product5" data-toggle="collapse" href="#in15" style="color: #ffffff;background-color:#255946;font-weight:bold">Solovita ACF</a></li>
                            <div id="in15" class="collapse" style="padding-left: 20px;">
                                <ul>
                                    <li><a href="solovita-10-0-40.php">Solovita 10-0-40</a></li>
                                    <li><a href="solovita-16-8-24.php">Solovita 16-8-24</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <a href="safgubreler-haifa-cal.php">
                                ...
                                <h5 style="margin-top: 0px; text-align:center">Haifa Cal</h5>
                            </a>
                        </div>
                        <div class="col-md-4">
