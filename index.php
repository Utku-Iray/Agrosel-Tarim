                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-7 col-lg-7">
                            ...
                            <h2><span>Tarımsal Üretimde Sürdürülebilir </span> <br> Yenilikçi Ürünler</h2>
                            <p><br> </p>
            ...
            <div class="swiper-slide">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-7 col-lg-7">
                            <!-- <span class="tagline">Welcome to Agriculture Farm</span> -->
                            <h2><span>Toprağa Düşen </span> Bereket<br>& Güven & Kalite & İstikrar
                            </h2>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-4 wow fadeInUp" data-wow-duration="1500ms">
                <div class="service-one__box">
                    ...
                    <div class="service-one__box-content">
                        <h3><a href="service-details.html">Bitki Beslenme Ürünleri</a></h3>
                    </div>
            ...
            <div class="col-md-12 col-lg-4 wow fadeInUp" data-wow-duration="1500ms">
                <div class="service-one__box">
                    ...
                    <div class="service-one__box-content">
                        <h3><a href="service-details.html">Damla Sulama Gübreleri</a></h3>
                    </div>
                    <!-- /.service-one__box-content -->
                </div>
                <!-- /.service-one__box -->
            ...
            <div class="col-md-12 col-lg-4 wow fadeInUp" data-wow-duration="1500ms">
                <div class="service-one__box">
                    ...
                    <div class="service-one__box-content">
                        <h3><a href="service-details.html">HAIFA Ürünleri</a></h3>
                    </div>
                    <!-- /.service-one__box-content -->
                </div>
                <!-- /.service-one__box -->
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-3">
                <div class="contact-two__content">
                    ...
                    <div class="contact-two__summery">
                        <p>Lorem ipsum dolor sit amet, consectetur notted adipisicing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua lonm andhn. Aenean tincidunt id mauris id auctor. Donec at ligula lacus dignissim mi quis simply
                            neque.</p>
                    </div>
