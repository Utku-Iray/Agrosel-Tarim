        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="service-sidebar">
                    ...
                    <div>
                        <a target="_blank" href="assets/images/pdf/magnisal-etiket.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black">Magnisal Etiket</span> </a>
                    </div>
                    <br>
                    <div>
                        <a target="_blank" href="assets/images/pdf/magnisal-tescil.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black">Magnisal Tescil</span></a>
                    </div>
                </div><!-- /.service-sidebar -->
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-8">
                ...
                <h5 style="margin-top: 20px;">MagnisalTM' ın Avantajları</h5>
                <div>
                ...
                <p>MagnisalTM suda yüksek bir çözünürlüğe sahiptir.
                    <br>
                ...
                <h5 style="margin-top: 25px;">Çeşitli Konsantrasyonlarda MagnisalTM'in pH ve EC Değerleri</h5>
                <table class="table" style="margin-top: 20px;">
                    <thead class="thead-dark">
                        <tr>
                            <th scope="col">#</th>
