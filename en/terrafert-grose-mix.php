...
<p>Terrafert Grose-Mix, which contains 100% EDTA chelated micro elements, is an excellent trace elements mixture manufactured with advanced technology in Turkey.</p>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/GROSE-MiX-ETiKET.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Grose - Mix Label</span> </a>
                        </div>
