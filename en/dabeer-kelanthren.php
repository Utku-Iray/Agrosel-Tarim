        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="service-sidebar__links">
                                ...
                                <ul>
                                    ...
                                    <div id="in5" class="collapse">
                                        <ul>
                                            ...
                                            <li  style="background-color: #e3e3e3;"> <a href="dabeer-kelanthren.php">Kelanthren %6 Fe</a></li>
                    ...
                    <div>
                        <a target="_blank" href="../assets/images/pdf/kelanthren-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black"> Kelanthren %6 Fe Ticket</span> </a>
                    </div>
                    <br>
                    <div>
                        <a target="_blank" href="../assets/images/pdf/kelanthren-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black"> Kelanthren %6 Fe Registration</span></a>
                    </div>
                </div><!-- /.service-sidebar -->
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-8">
                <h2 style="margin-top: 0px;">Kelanthren %6 Fe</h2>
                ...
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        <li>
                            ...
                            Kelanthren 6 % Fe, piyasadaki demirlerden farklı olarak bir şelat maddesiyle şelatlanmıştır. Bu şelat maddesi “EDDHSA “ dediğimiz kükürtlü bir şelat maddesidir.
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                            Kelanthren 6 % Fe ürününün 1 kg’’nı ortalama 2 lt suda rahatlıkla eridiğini göreceksiniz.
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            Ayrıca içerisindeki şelattan ötürü (EDDHSA) ilaçlama esnasında suyun pH’sını düzenleyerek ilacın etkinliğini arttırdığı da deneylerle kanıtlanmıştır. Örneğin; Vegetables kök çürüklüğüne “Hexythiazox” etken maddeli ilaçlarla karıştırıldığında damlamadan erilmek suretiyle iyi geldiği ve aynı zamanda damlamada herhangi bir tıkanıklığa yol açmadığı yine deneylerle kanıtlanmıştır.
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            Kelanthren 6 % Fe, tamamen kimyasal olup % 100 mikro granüldür
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            Kelanthren 6 % Fe, içerisindeki kükürtten dolayı bitki açısından alımı hem daha kolay hem de daha hızlıdır.
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                            Kelanthren 6 % Fe yapraktan ve damlamadan kullanılabilir.
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            Kelanthren 6 % Fe zirai ilaçlar ve gübrelerle karışabilir.
                        </li>
