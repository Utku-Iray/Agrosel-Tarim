                                ...
                                <ul>
                                    ...
                                    <div id="in2" class="collapse">
                                        <ul style="padding-left: 20px;">
                                            <li><a href="terrafert-glymax-pro.php">Glymax Pro</a></li>
            ...
            <div class="col-lg-8">
                ...
                <div class="col-md-4">
                        <a href="terrafert-adept.php">
                            ...
                            <h5 style="margin-top: -20px; text-align:center">Glymax Pro</h5>
                            <h6 style="margin-top: 0px; text-align:center">Organic Fertilizer with Amino Acids of Animal Origin</h6>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="terrafert-adept.php">
