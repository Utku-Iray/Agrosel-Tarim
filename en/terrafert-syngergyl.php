        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                    ...
                    <div class="modal-dialog" style="max-width:1000px !important">
                        <div class="modal-content">
                            <div class="modal-body">
                                <img src="../assets/images/en-synergyl.jpeg" class="img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
                <hr>
                <a href="#myModal" data-toggle="modal" data-target="#myModal1"><img src="../assets/images/en-synergyl-detay.jpeg" alt=""></a>

                <div id="myModal1" class="modal fade" tabindex="-1" role="dialog">
                    <div class="modal-dialog" style="max-width:1000px !important">
                        <div class="modal-content">
                            <div class="modal-body">
                                <img src="../assets/images/en-synergyl-detay.jpeg" class="img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/SYNERGYL-ETiKET.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> Synergyl Ticket</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/SYNERGYL-TESCiL.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Synergyl Registration</span></a>
                        </div>
                    </div>
                </div>
