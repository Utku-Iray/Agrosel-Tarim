...
<section class="service-details">
    <div class="container">
        <div class="row">
                            ...
                            <ul>
                                    ...
                                    <div id="in15" class="collapse" style="padding-left: 20px;">
                                        <ul>
                                            ...
                                            <li style="background-color: #e3e3e3;"><a href="neovent-acf-16-8-24.php">16.8.24+2MgO + TE</a></li>
            ...
            <div class="col-lg-8">
                <h2 style="margin-top: 0px;">Neovent 16-8-24 + 2MgO + TE</h2>
                <img src="../assets/images/neovent-gorsel/16824.jpg" alt="">
                <h5 style="margin-top: 20px;">Neovent 16.8.24+2MgO + TE; </h5>
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;"> Neovent 16.8.24+2MgO+TE; It is a water-soluble product containing high levels of potassium and nitrogen, sufficient amount of phosphorus and microelements.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;"> Neovent 16.8.24+2MgO+TE increases the efficiency of your greenhouse and field.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
...
<hr>
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/neovent-acf-pdf/etiket/16-8-24.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> 16-8-24 + TE Label</span> </a>
                        </div>
