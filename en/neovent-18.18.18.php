        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="service-sidebar__links">
                                ...
                                <ul>
                                    ...
                                    <div id="in15" class="collapse">
                                        <ul>
                                            ...
                                            <li  style="background-color: #e3e3e3;"><a href="neovent-18.18.18.php">Neovent 18.18.18 + TE</a></li>
                    ...
                    <div>
                        <a target="_blank" href="../assets/images/pdf/neovent-18.18.18-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black">Neovent 18.18.18 Ticket</span> </a>
                    </div>
                    <br>
                    <div>
                        <a target="_blank" href="../assets/images/pdf/neovent-18.18.18-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black">Neovent 18.18.18 Registration</span></a>
                    </div>
                </div><!-- /.service-sidebar -->
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-8">
                ...
                <table class="table" style="margin-top: 20px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>	0,212 EDTA+EDDHA Şelatlı</td>

                        </tr>
                        <tr>
                            <th scope="row">5</th>
                            <td>Suda Çözünür Mangan (Mn)</td>
                            <td>0,023 EDTA Şelatlı</td>

                        </tr>
                        <tr>
                            <th scope="row">6</th>
                            <td>Water Soluble Zınc (Zn)</td>
                            <td> 	0,026 EDTA Şelatlı</td>

                        </tr>
                        <tr>
                            <th scope="row">7</th>
                            <td>Water Soluble Cupper (Cu)</td>
                            <td> 0,012 EDTA Şelatlı</td>
                ...
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        <li>
                            ...
                            <span style="font-weight: bold;">Neovent 18.18.18+TE kırmızı, kuru kristal şeklinde, suda çabuk ve tamamen eriyen bir gübredir. Eşit oranlarda Azot (N), Fosfor (P) ve Potasyum (K)’un yanı sıra bitkilerin en çok istedikleri mikro elementleri içerir.</span>
                        </li>
