...
<head>
    ...
    <title>Terrafert Glymax - Pro | Organic Fertilizer with Amino Acids of Animal Origin | Agrosel Tarım </title>
    <!-- favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="../assets/images/favicons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="../assets/images/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="../assets/images/favicons/favicon-16x16.png">
    <link rel="manifest" href="../assets/images/favicons/site.webmanifest">
    <meta name="description" content="Hayvansal Menşeli Aminoasitli Organik Gübre Terrafert Glymax - Pro, yüksek organik madde ve karbon içeriği ile bitki köklenmesinde ve meyvelerin olgunlaşmasında önemli rol oynar.">
...
<section class="service-details">
    <div class="container">
        <div class="row">
                                ...
                                <ul>
                                    ...
                                    <div id="in2" class="collapse">
                                        <ul style="padding-left: 20px;">
                                            <li style="background-color: #e3e3e3;"><a href="terrafert-glymax-pro.php">Glymax</a></li>
            ...
            <div class="col-lg-8">
                <h2 style="margin-top: 0px;">Terrafert Glymax - Pro</h2>
                <img src="../assets/images/glymax.jpeg" alt="">
                <h3 style="margin-top: 0px;">Organic Fertilizer with Amino Acids of Animal Origin</h3>
                <p>With the high amount of free amino acids in its content, it protects the amino acid balance of plants and increases their resistance to stress conditions; and ensures the best realization of vegetative and generative development. In addition, it increases the quality and yield of the product by playing an active role in activities such as root formation, flower formation, shoot development, etc. that take place in all development periods of plants from planting to harvest.
                </p>
                <hr>
                <a href="#myModal" data-toggle="modal" data-target="#myModal"><img src="../assets/images/glymax-en-kullanim1.jpeg" alt=""></a>

                <div id="myModal" class="modal fade" tabindex="-1" role="dialog">
                    <div class="modal-dialog" style="max-width:1000px !important">
                        <div class="modal-content">
                            <div class="modal-body">
                                <img src="../assets/images/glymax-en-kullanim1.jpeg" class="img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
                <hr>
                <a href="#myModal2" data-toggle="modal" data-target="#myModal2"><img src="../assets/images/glymax-en-kullanim2.jpeg" alt=""></a>

                <div id="myModal2" class="modal fade" tabindex="-1" role="dialog">
                    <div class="modal-dialog" style="max-width:1000px !important">
                        <div class="modal-content">
                            <div class="modal-body">
                                <img src="../assets/images/glymax-en-kullanim2.jpeg" class="img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <hr>
                <h5 style="margin-top: 20px;">Terrafert Glymax - Pro Packaging::</h5>
                <div>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/terrafert-glymax-pro-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> Glymax Label</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/terrafert-glymax-pro-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Glymax Registration</span></a>
                        </div>
                    </div>
                </div>
