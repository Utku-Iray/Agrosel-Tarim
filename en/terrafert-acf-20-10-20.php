...
<head>
    ...
    <title>Terrafert 20-10-20 + TE | NPK Fertilizer | Agrosel Tarım </title>
    <!-- favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="../assets/images/favicons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="../assets/images/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="../assets/images/favicons/favicon-16x16.png">
    <link rel="manifest" href="../assets/images/favicons/site.webmanifest">
    <meta name="description" content="Terrafert 20-10-20 + TE blended npk fertilizer for agirculture. Manufactured by Agrosel Tarım in Turkey.">
    ...
    <link rel="alternate" href="https://www.agroseltarim.com/terrafert-acf-20-10-20.php" hreflang="tr-tr" />
<link rel="alternate" href="https://www.agroseltarim.com/en/terrafert-acf-20-10-20.php" hreflang="x-default" />
    ...
    <div class="container">
        <div class="row">
                                ...
                                <ul>
                                    ...
                                    <div id="in3" class="collapse" style="padding-left: 20px;">
                                        <ul>
                                            ...
                                            <li style="background-color: #e3e3e3;"><a href="terrafert-acf-20-10-20.php">20-10-20 + TE</a></li>
            ...
            <div class="col-lg-8">
                ...
                <h5 style="margin-top: 20px;">Terrafert 20-10-20 + TE NPK Fertilizer</h5>
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;"> Terrafert 20-10-20 + TE; It is a dry crystalline fertilizer that dissolves quickly and completely in water. It contains Nitrogen (N), Phosphorus (P) and Potassium (K) as well as the most desired micro elements of plants.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;"> The nitrogen source of Terrafert 20-10-20 + TE consists of Ammonium and Nitrate. (It is urea free.)</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;"> Micro elements in Terrafert 20-10-20 + TE are chelated. Thus, it is not washed and it is always in a form that can be absorbed by plants since it does not flicker.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;"> It accelerates root formation and development.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;"> It has high solubility and absorbtion capacity.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/201020-ETiKET.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">20-10-20 + TE Label</span> </a>
                        </div>
