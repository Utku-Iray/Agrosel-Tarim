        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="service-sidebar__links">
                                ...
                                <ul>
                                    ...
                                    <div id="in3" class="collapse">
                                        <ul>
                                            ...
                                            <li  style="background-color: #e3e3e3;"><a href="abt-elpaso.php">Elpaso</a></li>
                                        </ul>
                    ...
                    <div>
                        <a target="_blank" href="../assets/images/pdf/elpaso-etkiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black"> Elpaso Ticket</span> </a>
                    </div>
                    <br>
                    <div>
                        <a target="_blank" href="../assets/images/pdf/elpaso-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black"> Elpaso Registration</span></a>
                    </div>
                </div><!-- /.service-sidebar -->
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-8">
                ...
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        <li>
                            ...
                            Bütün topraklarda kullanılmak üzere hazırlanmış, tamamı bitki tarafından alınabilen yüksek kaliteye sahip bio-nutrient içerikli sıvı bir gübredir. Bitkilerin tüm gelişim döneminde Drip ve yapraktan uygulanır.
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
