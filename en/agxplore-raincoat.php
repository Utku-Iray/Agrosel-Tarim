...
<section class="service-details">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                <h2 style="margin-top: 0px;">RainCoat</h2>
                <img src="../assets/images/services/service-d-1-1.jpg" alt="">
                <h3 style="margin-top: 20px;">"ÇATLAMAYA KARŞI EN İYİ SAVUNMA"</h3>
                <h5>Cherry Cracking Suppressant</h5>
                <h5>Etkin Madde: Water, Fatty Acids, vegetable esters & emulsifiers 100 %</h5>
                ...
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                            Doğal bir emülsiyon teknolojisine sahip olan RainCoat, meyve yüzeyinin geçirgenliğini en aza indirerek çatlamaya neden olan ıslanma ve aşırı nemlenmeye karşı etkili bir savunma sağlar.
                        </li>
                        <h5 style="margin-top: 25px;">Faydaları:</h5>

                        <li>
                            <i class="fa fa-check-circle"></i>
                            Doğal emülsiyon teknolojisi sayesinde ciddi miktarda meyve çatlamasını azaltır.
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            Kalıntı bırakmadan kirazın doğal kütiküla tabakası yüzeyini tamamlar.
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
