...
<head>
    ...
    <title>Haifa Multifeed 15-30-15 | Solube NPK Fertilizer | Agrosel Tarım  </title>
    <!-- favicons Icons -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <h3 style="margin-top: 20px;">Multifeed 15.30.15+2MgO+ME</h3>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/Multi-15.30.15-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> 15.30.15 Label</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/Multi-15.30.15-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> 15.30.15 Registration</span></a>
                        </div>
                    </div>
                </div>
