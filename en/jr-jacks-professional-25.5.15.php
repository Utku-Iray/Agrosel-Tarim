...
<section class="service-details">
    <div class="container">
        <div class="row">
                ...
                <ul>
                            ...
                            <div id="in16" class="collapse" style="padding-left: 20px;">
                                <ul>
                                    ...
                                    <li style="background-color: #e3e3e3;"><a href="jr-jacks-professional-25.5.15.php">Jack's Professional 25.5.15+ME</a></li>
            ...
            <div class="col-lg-8">
                <h2 style="margin-top: 0px;">Jack's Professional 25.5.15+ME</h2>
                <img src="../assets/images/jr-25-5-15.jpg" alt="">
                <h3 style="margin-top: 20px;">"Jack's Professional High Performance 25.5.15+ME"</h3>
...
Formulation</th>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/jacks-prof-25.5.15-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> 25.5.15+ME Ticket</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/jacks-prof-25.5.15-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">25.5.15+ME Registration</span></a>
                        </div>
                    </div>
                </div>
