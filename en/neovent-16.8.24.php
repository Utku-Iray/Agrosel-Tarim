...
<head>
    ...
    <title>Neovent 16-8-24 |  NPK Fertilizer | Agrosel Tarım</title>
    <!-- favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="../assets/images/favicons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="../assets/images/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="../assets/images/favicons/favicon-16x16.png">
    <link rel="manifest" href="../assets/images/favicons/site.webmanifest">
    <meta name="description" content="Neovent 16-8-24 + 2MgO + TE blended npk fertilizer for agirculture. Manufactured by Agrosel Tarım in Turkey.">
    ...
    <link rel="alternate" href="https://www.agroseltarim.com/neovent-acf-16-8-24.php" hreflang="tr-tr" />
<link rel="alternate" href="https://www.agroseltarim.com/en/neovent-acf-16-8-24.php" hreflang="x-default" />
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="service-sidebar__links">
                                ...
                                <ul>
                                    ...
                                    <div id="in15" class="collapse">
                                        <ul>
                                            ...
                                            <li  style="background-color: #e3e3e3;"><a href="neovent-16.8.24.php">Neovent 16.8.24+2MgO + TE</a></li>
                    ...
                    <div>
                        <a target="_blank" href="../assets/images/pdf/neovent-16.7.24-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black">Neovent 16.8.24 Label</span> </a>
                    </div>
                    <br>
                    <div>
            ...
            <div class="col-lg-8">
                ...
                <table class="table" style="margin-top: 20px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row">2</th>
                            <td>Suda Çözünür P2O5</td>
                            <td>8</td>

                        </tr>
                        <tr>
                            <th scope="row">3</th>
                            <td>Suda Çözünür K2O</td>
                            <td> 24</td>

                        </tr>
                        <tr>
                            <th scope="row">4</th>
                            <td>Suda Çözünür MgO</td>
                            <td> 2</td>
                        ...
                        <tr>
                            ...
                            <td> 0,22 EDTA+EDDHA Şelatlı</td>

                        </tr>
                        <tr>
                            <th scope="row">6</th>
                            <td>Suda Çözünür Mangan (Mn)</td>
                            <td>0,025 EDTA Şelatlı</td>

                        </tr>
                        <tr>
                            <th scope="row">7</th>
                            <td>Water Soluble Zınc (Zn)</td>
                            <td> 0,027 EDTA Şelatlı</td>

                        </tr>
                        <tr>
                            <th scope="row">8</th>
                            <td>Water Soluble Cupper (Cu)</td>
                            <td> 0,013 EDTA Şelatlı</td>
                ...
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        <li>
                            ...
                            <span style="font-weight: bold;">Neovent 16.8.24+2MgO+TE; suda çözünebilen yüksek oranda potasyum ve azot, yeterli miktarda fosfor ve mikro element ihtiva eden bir üründür.</span>
                        </li>
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">Neovent 16.8.24+2MgO+TE seranızın ve tarlanızın verimini arttırır.</span>
                        </li>
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;"> Bitkinizin hastalıklara karşı direncini arttırır.
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
