...
<section class="service-details">
    <div class="container">
        <div class="row">
                        ...
                        <ul>
                            ...
                            <div id="in16" class="collapse" style="padding-left: 20px;">
                                <ul>
                                    ...
                                    <li><a href="tribodyn-lithovit.php">Lithovit CO2</a></li>
                                    <li style="background-color: #e3e3e3;"><a href="chi-liquid.php">GHP Liquid Humus Plus</a></li>
                                </ul>
                            </div>
            ...
            <div class="col-lg-8">
                <h2 style="margin-top: 0px;">GHP Liquid Humus Plus</h2>
                <img src="../assets/images/humus.jpg" alt="">
                
               
                <h5>"Liquid Humic Acid From Leonardite"</h5>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/jr-ghp.PDF"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">GHP Liquid Ticket</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/jr-ghp-tescil.PDF"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">GHP Liquid Registration</span></a>
                        </div>
                    </div>
                </div>
