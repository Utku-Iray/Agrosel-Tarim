...
<head>
    ...
    <title>Terrafert Foliar 10-40-10 | Agrosel Tarım </title>
    <!-- favicons Icons -->
...
<section class="page-header">
    ...
    <div class="container">
        ...
        <h2>Terrafert Foliar 10-40-10</h2>
    </div><!-- /.container -->
</section><!-- /.page-header -->
...
<section class="service-details">
    <div class="container">
        <div class="row">
                                ...
                                <ul>
                                    ...
                                    <div id="in2" class="collapse">
                                        <ul style="padding-left: 20px;">
                                            ...
                                            <li style="background-color: #e3e3e3;"><a href="terrafert-foliar-10-40-10.php">Foliar 10-40-10</a></li>
            ...
            <div class="col-lg-8">
                <h2 style="margin-top: 0px;">Terrafert Foliar 10-40-10</h2>
                <img src="../assets/images/terrafert-foliar-10-40-10.jpeg" alt="">
                <h3 style="margin-top: 0px;">Terrafert Foliar 10-40-10 </h3>
                <p> Special foliar fertilizers; starting from the vegetative development period of the plants, thanks to the special formulations specific to 
the plant species,It is a unique NPK foliar fertilizer that provides the necessary nutrients in the most appropriate way. TERRAFERT FOLIAR special foliar 
fertilizers; your upbringingThanks to its advanced technologies, it helps to meet the additional nutritional needs of plants even in difficult adverse weather conditions.
                </p>
                <hr>
                <a href="#myModal" data-toggle="modal" data-target="#myModal"><img src="../assets/images/en-terrafert-10-40-10-foliar1.jpeg" alt=""></a>

                <div id="myModal" class="modal fade" tabindex="-1" role="dialog">
                    <div class="modal-dialog" style="max-width:1000px !important">
                        <div class="modal-content">
                            <div class="modal-body">
                                <img src="../assets/images/en-terrafert-10-40-10-foliar1.jpeg" class="img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
                <hr>
                <a href="#myModal2" data-toggle="modal" data-target="#myModal2"><img src="../assets/images/en-terrafert-foliar2.jpeg" alt=""></a>

                <div id="myModal2" class="modal fade" tabindex="-1" role="dialog">
                    <div class="modal-dialog" style="max-width:1000px !important">
                        <div class="modal-content">
                            <div class="modal-body">
                                <img src="../assets/images/en-terrafert-foliar2.jpeg.jpeg" class="img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <hr>
                <h5 style="margin-top: 20px;">Terrafert Foliar 10-40-10 Packaging:</h5>
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;"> 2 Kg</span>
                        </li>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/terrafert-foliar-10-40-10-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> Foliar 10-40-10 Label</span> </a>
                        </div>
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/terrafert-foliar-10-40-10-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Foliar 10-40-10 Registration</span></a>
                        </div>
                    </div>
                </div>
