        ...
        <div class="row">
                                ...
                                <ul>
                                    ...
                                    <div id="in15" class="collapse" style="padding-left: 20px;">
                                        <ul>
                                            ...
                                            <li style="background-color: #e3e3e3;"><a href="neovent-acf-19-6-20.php">19.6.20+2MgO + TE</a></li>
            ...
            <div class="col-lg-8">
                ...
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        <li>
                            ...
                            <span style="font-weight: bold;"> Neovent 19.6.20+2MgO+TE; It is a water-soluble product containing high levels of potassium and nitrogen, sufficient amount of phosphorus and microelements.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;"> Neovent 19.6.20+2MgO+TE increases the efficiency of your greenhouse and field</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/neovent-acf-pdf/etiket/19-6-20.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> 19-6-20 + TE Ticket</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/neovent-acf-pdf/tescil/19-6-20.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> 19-6-20 + TE Registration</span></a>
                        </div>
                    </div>
                </div>
