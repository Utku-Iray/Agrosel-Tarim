    ...
    <div class="container">
        <div class="row">
                                ...
                                <ul>
                                    ...
                                    <div id="in11" class="collapse" style="padding-left: 20px;">
                                        <ul>
                                            ...
                                            <li style="background-color: #e3e3e3;"><a href="potasyum-nitrat-multi-k-gg.php">Multi-K GG</a></li>
            ...
            <div class="col-lg-8">
                ...
                <h3 style="margin-top: 20px;">"Multi-K  GG"</h3>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/gg-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Multi-K GG  Etiket</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/gg-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Multi-K GG  Tescil</span></a>
                        </div>
                    </div>
                </div>
