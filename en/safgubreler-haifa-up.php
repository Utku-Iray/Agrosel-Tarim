    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <h3 style="margin-top: 20px;">"Urea Phosphate""</h3>
                <p>Haifa UP, Nutrigation for all vegetables and fruit trees <br>
                    It is a urea phosphate for application. <br>
                    Haifa UP is suitable for the preparation of fertilizer mixes and for the production of liquid fertilizers.
                </p>
                ...
                <p>Note : Haifa UP should not be mixed with Calcium or Magnesium fertilizers.</p>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/Haifa-UP-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Haifa UP Ticket</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/Haifa-UP-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Haifa UP Registration</span></a>
                        </div>
                    </div>
                </div>
