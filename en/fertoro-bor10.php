        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="service-sidebar__links">
                    ...
                    <div>
                    <a target="_blank" href="../assets/images/pdf/bor10etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black"> BOR10 Label</span> </a>
                    </div>
                    <br>
                    <div>
