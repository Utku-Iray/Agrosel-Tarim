...
<head>
    ...
    <title>Neovent 20-10-20 + TE | NPK Fertilizer | Agrosel Tarım </title>
    <!-- favicons Icons -->
...
<section class="service-details">
    <div class="container">
        <div class="row">
                                ...
                                <ul>
                                    ...
                                    <div id="in15" class="collapse" style="padding-left: 20px;">
                                        <ul>
                                            ...
                                            <li style="background-color: #e3e3e3;"><a href="neovent-acf-20-10-20.php">20.10.20 + TE</a></li>
                                        </ul>
                                    </div>
            ...
            <div class="col-lg-8">
                <h2 style="margin-top: 0px;">Neovent 20-10-20 + TE</h2>
                <img src="../assets/images/neovent-gorsel/201020.jpg" alt="">
                <h5 style="margin-top: 20px;">Neovent 20.10.20 + TE NPK Fertilizer </h5>
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;"> Neovent  20-10-20 + TE; It is a dry crystalline fertilizer that dissolves quickly and completely in water. It contains Nitrogen (N), Phosphorus (P) and Potassium (K) as well as the most desired micro elements of plants.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;"> The nitrogen source of Neovent  20-10-20 + TE consists of Ammonium and Nitrate. (It is urea free.)</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;"> Micro elements in Neovent  20-10-20 + TE are chelated. Thus, it is not washed and it is always in a form that can be taken for plants since it does not flicker.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;"> It does not cause sediment in the drip system and does not cause clogging.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;"> It has high resolution and receivable capacity.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;"> It can be used easily from leaves in sensitive products.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/neovent-acf-pdf/etiket/20-10-20.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> 20-10-20 + TE Label</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/neovent-acf-pdf/tescil/20-10-20.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> 20-10-20 + TE Registration</span></a>
                        </div>
                    </div>
                </div>
