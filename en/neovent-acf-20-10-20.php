            ...
            <div class="col-lg-8">
                ...
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;"> The nitrogen source of Neovent  20-10-20 + TE consists of Ammonium and Nitrate. (It is urea.)</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/neovent-acf-pdf/etiket/20-10-20.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> 20-10-20 + TE Ticket</span> </a>
                        </div>
