...
<section class="service-details">
    <div class="container">
        <div class="row">
                                ...
                                <ul>
                                    ...
                                    <div id="in11" class="collapse" style="padding-left: 20px;">
                                        <ul>
                                            ...
                                            <li style="background-color: #e3e3e3;"><a href="potasyum-nitrat-multi-k-phast.php">Multi-K pHast</a></li>
            ...
            <div class="col-lg-8">
                <h2 style="margin-top: 0px;">Multi-K pHast</h2>
                <img src="../assets/images/Multi-K-pHast-kapak.jpg" alt="">
                <h3 style="margin-top: 20px;">"Multi-K  pHast"</h3>
                <h5>"Potassium Nitrate Low pH"</h5>
                <h5>"13.5-0-46.2 Potassium Nitrate, 100% water soluble, NK fertilizer"</h5>
                ...
                <table class="table" style="margin-top: 20px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row">3</th>
                            <td>Water Soluble Potassium (K)</td>
                            <td>% 38,4</td>
                        ...
                        <tr>
                            <th scope="row">5</th>
                            <td> Moisture ( 1hr, 105oC)</td>
                            <td>% 0,09</td>

                        </tr>
                        <tr>
                            <th scope="row">6</th>
                            <td> İnsoluble Matter</td>
                            <td>350 ppm</td>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/phast-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Multi-K pHast  Ticket</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/phast-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Multi-K pHast  Registration</span></a>
                        </div>
                    </div>
                </div>
