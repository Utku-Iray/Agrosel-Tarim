...
<head>
    ...
    <title>Haifa Multifeed 16-8-24 | Solube NPK Fertilizer | Agrosel Tarım</title>
    <!-- favicons Icons -->
...
<section class="service-details">
    <div class="container">
        <div class="row">
                                ...
                                <ul>
                                    ...
                                    <div id="in9" class="collapse" style="padding-left: 20px;">
                                        <ul>
                                            ...
                                            <li style="background-color: #e3e3e3;"><a href="haifa-npk-16.8.24.php">Multifeed 16.8.24+2MgO+ME</a></li>
            ...
            <div class="col-lg-8">
                <h2 style="margin-top: 0px;">Multifeed 16.8.24+2MgO+ME</h2>
                <img src="../assets/images/mullti-feed-kapak.jpeg" alt="">
                <h3 style="margin-top: 20px;">Multifeed 16.8.24+2MgO+ME</h3>
                ...
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                             Suitable for all vegetables, trees and open field cultivation (NutrigationTM).
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/Multifeed-16.8.24-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> Multifeed-16.8.24 Label</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/Multifeed-16.8.24-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> Multifeed-16.8.24 Registration</span></a>
                        </div>
                    </div>
                </div>
