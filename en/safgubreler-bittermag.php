    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <h3 style="margin-top: 20px;">"Magnesium Sulphate"</h3>
                <p>Haifa BitterMag is a water-soluble, crystalline Magnesium Sulphate fertilizer for application. Haifa BitterMag is suitable for the preparation of fertilizer mixes and for the production of liquid fertilizers. It is recommended when magnesium is required and nitrogen fertilization should be avoided.</p>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/bittermag-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">BitterMag Ticket</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/bittermag-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">BitterMag Registration</span></a>
                        </div>
                    </div>
                </div>
