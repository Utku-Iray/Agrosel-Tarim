        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="service-sidebar__links">
                                ...
                                <ul>
                                    ...
                                    <div id="in5" class="collapse">
                                        <ul>
                                            ...
                                            <li  style="background-color: #e3e3e3;"> <a href="dabeer-ferrosel.php">Ferrosel %6 Fe</a></li>
                    ...
                    <div>
                        <a target="_blank" href="../assets/images/pdf/ferrosel-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black"> Ferrosel %6 Fe Ticket</span> </a>
                    </div>
                    <br>
                    <div>
                        <a target="_blank" href="../assets/images/pdf/ferrosel-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black"> Ferrosel %6 Fe Registration</span></a>
                    </div>
                </div><!-- /.service-sidebar -->
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-8">
                <h2 style="margin-top: 0px;">Ferrosel %6 Fe</h2>
                ...
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        <li>
                            ...
                            Ferrosel Fe, piyasadaki demirlerden farklı olarak bir şelat maddesiyle şelatlanmıştır. Bu şelat maddesi “EDDHSA “ dediğimiz kükürtlü bir şelat maddesidir.
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                            Ferrosel Fe ürününün 1 kg’’nı ortalama 2 lt suda rahatlıkla eridiğini göreceksiniz.
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                            Ferrosel Fe, tamamen kimyasal olup % 100 mikro granüldür.
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            Ferrosel Fe, içerisindeki kükürtten dolayı bitki açısından alımı hem daha kolay hem de daha hızlıdır.
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                            Ferrosel Fe yapraktan ve damlamadan kullanılabilir.
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            Ferrosel Fe zirai ilaçlar ve gübrelerle karışabilir.
                        </li>
