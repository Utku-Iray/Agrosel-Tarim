...
<section class="service-details">
    <div class="container">
        <div class="row">
                        ...
                        <ul>
                            ...
                            <div id="in16" class="collapse" style="padding-left: 20px;">
                                <ul>
                                    ...
                                    <li style="background-color: #e3e3e3;"><a href="jr-jacks-professional-20.10.20.php">Jack's Professional 20.10.20+ME</a></li>
            ...
            <div class="col-lg-8">
                <h2 style="margin-top: 0px;">Jack's Professional 20.10.20+ME</h2>
                <img src="../assets/images/jr-20-10-20.jpg" alt="">
                <h3 style="margin-top: 20px;">"Jack's Professional Peat-Lite 20.10.20 + ME"</h3>
                ...
                <table class="table" style="margin-top: 20px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> 0,1 EDTA Şelatlı</td>

                        </tr>
                        <tr>
                            <th scope="row">7</th>
                            <td>Suda Çözünür Mangan (Mn)</td>
                            <td> 0,05 EDTA Şelatlı</td>
                ...
                <table class="table" style="margin-top: 20px;">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th scope="col">Usage Suggestion</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <th scope="row">1</th>
                            <td>20.10.20 + ME</td>
                            <td>Peat-Lite 77860T</td>
                            <td>
                                It is a popular formulation and contains two times more microelements than general purposes, and helps to eliminate the deficiency in this aspect in the plant.</td>
                ...
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        <li>
                            ...
                            <span style="font-weight: bold;">11,34 kg.</span>
                        </li>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/jacks-prof-20.10.20-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> 20.10.20 Ticket</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/jacks-prof-20.10.20-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">20.10.20 Registration</span></a>
                        </div>
                    </div>
                </div>
