        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="service-sidebar__links">
                    ...
                    <div>
                        <a target="_blank" href="../assets/images/pdf/seelife-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black"> Seelife Label</span> </a>
                    </div>
                    <br>
                    <div>
            ...
            <div class="col-lg-8">
                ...
                <table class="table" style="margin-top: 20px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row">5</th>
                            <td>Çilek ve Ornamental Plants</td>
                            <td> 50-100 cc</td>
                            <td>	0,5-1 lt.</td>
