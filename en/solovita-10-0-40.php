...
<section class="service-details">
    <div class="container">
        <div class="row">
                            ...
                            <div class="collapse" id="in14" style="font-weight:bold;padding-left:20px">
                                <ul>
                                    ...
                                    <div id="in55" class="collapse" style="padding-left: 20px;">
                                        <ul>
                                            <li style="background-color: #e3e3e3;"><a href="solovita-10-0-40.php">Solovita 10-0-40</a></li>
            ...
            <div class="col-lg-8">
                <h2 style="margin-top: 0px;">Solovita 10-0-40 + TE</h2>
                <img src="../assets/images/pdf/solovita/10-0-40+te.jpeg" alt="">
                <h5>Solovita 10-0-40 + TE</h5>
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;"> Solovita 10-0-40 + TE; It is a 100% water soluble fertilizer containing high potassium.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
