...
<head>
    ...
    <title>Terrafert 18-18-18 + TE | NPK Fertilizer | Agrosel Tarım  </title>
    <!-- favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="../assets/images/favicons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="../assets/images/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="../assets/images/favicons/favicon-16x16.png">
    <link rel="manifest" href="../assets/images/favicons/site.webmanifest">
    <meta name="description" content="Terrafert 18-18-18 + TE blended npk fertilizer for agirculture. Manufactured by Agrosel Tarım in Turkey. ">
...
<section class="service-details">
    <div class="container">
        <div class="row">
                            ...
                            <div class="collapse" id="in14" style="font-weight:bold;padding-left:20px">
                                <ul>
                                    ...
                                    <div id="in3" class="collapse" style="padding-left: 20px;">
                                        <ul>
                                            <li style="background-color: #e3e3e3;"><a href="terrafert-acf-18-18-18.php">18-18-18 + TE</a></li>
            ...
            <div class="col-lg-8">
                <h2 style="margin-top: 0px;">Terrafert  18-18-18 + TE</h2>
                <img src="../assets/images/181818.jpg" alt="">
                <h5 style="margin-top: 20px;">Terrafert 18.18.18 + TE NPK Fertilizer </h5>
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">Terrafert 18.18.18+TE; It is a dry crystalline fertilizer that dissolves quickly and completely in water. In addition to Nitrogen (N), Phosphorus (P) and Potassium (K) in equal proportions, it contains the most desired micro elements for plants.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">Terrafert 18.18.18+TE nitrogen source consists of Ammonium and Nitrate. (It is urea free.)</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">Micro elements in Terrafert 18.18.18+TE are chelated. Thus, it is not washed and it is always in a form that can be easily absorbed by plants since it does not flicker.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">It promotes germination and seed formation.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">It accelerates root formation and root development.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">It increases the resistance of the plant against cold and drought.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">Used to revive poorly growing plants</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">Since it does not contain urea, it can be used easily in all seasons of vegetables.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">It does not contain Chlorine (Cl).</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">It does not cause sediment in the drip irrigation system and does not cause clogging.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">It has high solubility and absorption capacity.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">Does not contain heavy metals.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">It is a fertilizer very suitable for intensive agriculture since it does not contain Chlorine (Cl) and Sodium (Na).</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">It can be used easily from leaves with foliar application in sensitive products.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">It is a specific fertilizer that can be absorbed quickly and shows its effect fast.</span>
                        </li>
...
<hr>
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/181818-ETiKET.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">18-18-18 + TE Label</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/181818-TESCiL.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">18-18-18 + TE Registration</span></a>
                        </div>
                    </div>
                </div>
