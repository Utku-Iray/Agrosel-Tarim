    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <h5 style="margin-top: 20px;">Terrafert 18.18.18 + TE  </h5>
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">Terrafert 18.18.18+TE; It is a dry crystalline fertilizer that dissolves quickly and completely in water. In addition to Nitrogen (N), Phosphorus (P) and Potassium (K) in equal proportions, it contains the most desired micro elements of plants.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">Terrafert 18.18.18+TE nitrogen source consists of Ammonium and Nitrate. (It is urea.)</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">Micro elements in Terrafert 18.18.18+TE are chelated. Thus, it is not washed and it is always in a form that can be taken for plants since it does not flicker.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
...
<hr>
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/181818-ETiKET.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">18-18-18 + TE Ticket</span> </a>
                        </div>
