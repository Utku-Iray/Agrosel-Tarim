        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="service-sidebar__links">
                                ...
                                <ul>
                                    ...
                                    <div id="in15" class="collapse">
                                        <ul>
                                            ...
                                            <li  style="background-color: #e3e3e3;"><a href="neovent-20.10.20.php">Neovent 20.10.20 + TE</a></li>
                                        </ul>
                                    </div>
                    ...
                    <div>
                        <a target="_blank" href="../assets/images/pdf/neovent-20-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black">Neovent 20.10.20 Ticket</span> </a>
                    </div>
                    <br>
                    <div>
                        <a target="_blank" href="../assets/images/pdf/neovent-20-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black">Neovent 20.10.20 Registration</span></a>
                    </div>
                </div><!-- /.service-sidebar -->
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-8">
                ...
                <table class="table" style="margin-top: 20px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>0,2 EDTA+EDDHA Şelatlı</td>

                        </tr>
                        <tr>
                            <th scope="row">5</th>
                            <td>Suda Çözünür Mangan (Mn)</td>
                            <td>0,02 EDTA Şelatlı</td>
                ...
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        <li>
                            ...
                            <span style="font-weight: bold;">Neovent 20.10.20+TE kırmızı, kuru kristal şeklinde, suda çabuk ve tamamen eriyen bir gübredir. İçeriğinde bulunan Azot (N), Fosfor (P) ve Potasyum (K)’un yanı sıra bitkilerin en çok istedikleri mikro elementleri içerir.</span>
                        </li>
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">Soğuk hava koşullarında dahi bitkide gerekli değişiklikleri gösterir.
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
