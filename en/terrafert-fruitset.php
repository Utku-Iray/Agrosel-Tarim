...
<head>
    ...
    <title>Terrafert Fruitset | Agrosel Tarım </title>
    <!-- favicons Icons -->
...
<section class="service-details">
    <div class="container">
        <div class="row">
                                ...
                                <ul>
                                    ...
                                    <div id="in2" class="collapse">
                                        <ul style="padding-left: 20px;">
                                            ...
                                            <li style="background-color: #e3e3e3;"><a href="terrafert-fruitset.php">Fruitset</a></li>
            ...
            <div class="col-lg-8">
                <h2 style="margin-top: 0px;">Terrafert Fruitset</h2>
                <img src="../assets/images/fruit-set.jpeg" alt="">
                <h3 style="margin-top: 0px;">Terrafert Fruitset</h3>
                <p>  Elimination of nutrient deficiencies caused by trace element deficiencies, which contain high levels of micronutrientsIt 
is an excellent product obtained with advanced technology, all of the microelements are 100% EDTA chelated, which ensures a high quality crop.
                </p>
                <hr>
                <a href="#myModal" data-toggle="modal" data-target="#myModal"><img src="../assets/images/en-fruitset1.jpeg" alt=""></a>

                <div id="myModal" class="modal fade" tabindex="-1" role="dialog">
                    <div class="modal-dialog" style="max-width:1000px !important">
                        <div class="modal-content">
                            <div class="modal-body">
                                <img src="../assets/images/en-fruitset1.jpeg" class="img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
                <hr>
                <a href="#myModal2" data-toggle="modal" data-target="#myModal2"><img src="../assets/images/en-fruitset2.jpeg" alt=""></a>

                <div id="myModal2" class="modal fade" tabindex="-1" role="dialog">
                    <div class="modal-dialog" style="max-width:1000px !important">
                        <div class="modal-content">
                            <div class="modal-body">
                                <img src="../assets/images/en-  fruitset2.jpeg" class="img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <hr>
                <h5 style="margin-top: 20px;">Terrafert Fruitset Packaging:</h5>
                <div>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/fruit-set-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> Fruitset Label</span> </a>
                        </div>
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/fruit-set-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Fruitset Registration</span></a>
                        </div>
                    </div>
                </div>
