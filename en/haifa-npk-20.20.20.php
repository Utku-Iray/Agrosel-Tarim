...
<head>
    ...
    <title>Haifa Multifeed 20-20-20 | Solube NPK Fertilizer | Agrosel Tarım</title>
    <!-- favicons Icons -->
    ...
    <div class="container">
        <div class="row">
                                ...
                                <ul>
                                    ...
                                    <div id="in9" class="collapse" style="padding-left: 20px;">
                                        <ul>
                                            ...
                                            <li style="background-color: #e3e3e3;"><a href="haifa-npk-20.20.20.php">Multifeed 20.20.20+ME</a></li>
            ...
            <div class="col-lg-8">
                ...
                <h3 style="margin-top: 20px;">Multifeed 20.20.20+ME</h3>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/Multifeed-20.20.20-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> 20.20.20 Label</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/Multifeed-20.20.20-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> 20.20.20 Registration</span></a>
                        </div>
                    </div>
                </div>
