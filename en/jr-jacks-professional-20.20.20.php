...
<section class="service-details">
    <div class="container">
        <div class="row">
                ...
                <ul>
                            ...
                            <div id="in16" class="collapse" style="padding-left: 20px;">
                                <ul>
                                    ...
                                    <li style="background-color: #e3e3e3;"><a href="jr-jacks-professional-20.20.20.php">Jack's Professional 20.20.20+ME</a></li>
            ...
            <div class="col-lg-8">
                <h2 style="margin-top: 0px;">Jack's Professional 20.20.20+ME</h2>
                <img src="../assets/images/jr-20-20-20.jpg" alt="">
                <h3 style="margin-top: 20px;">"Jack's Professional General Purpose 20.20.20+ME"</h3>
                ...
                <table class="table" style="margin-top: 20px;">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row">1</th>
                            <td>20.20.20 + ME</td>
                            <td>General Purpose 77010T</td>
                            <td>It is intended to meet the general purpose, balanced nutritional needs of the plant.</td>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/jacks-prof-20.20.20-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> 20.20.20+ME Ticket</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/jacks-prof-20.20.20-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">20.20.20+ME Registration</span></a>
                        </div>
                    </div>
                </div>
