        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="service-sidebar__links">
                                ...
                                <ul>
                                    ...
                                    <div id="in5" class="collapse">
                                        <ul>
                                            ...
                                            <li  style="background-color: #e3e3e3;"> <a href="dabeer-power.php">Power Fe</a></li>
                    ...
                    <div>
                        <a target="_blank" href="../assets/images/pdf/power-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black"> Power Fe Ticket</span> </a>
                    </div>
                    <br>
                    <div>
                        <a target="_blank" href="../assets/images/pdf/power-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black"> Power Fe Registration</span></a>
                    </div>
                </div><!-- /.service-sidebar -->
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-8">
                <h2 style="margin-top: 0px;">Power Fe</h2>
                ...
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        <li>
                            ...
                            Power Fe, piyasadaki demirlerden farklı olarak bir şelat maddesiyle şelatlanmıştır. Bu şelat maddesi “EDDHSA “ dediğimiz kükürtlü bir şelat maddesidir.
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                            Power Fe ürününün 1 kg’’nı ortalama 2 lt suda rahatlıkla eridiğini göreceksiniz.
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                            Power Fe, tamamen kimyasal olup % 100 mikro granüldür.
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            Power Fe, içerisindeki kükürtten dolayı bitki açısından alımı hem daha kolay hem de daha hızlıdır.
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                         Power Fe zirai ilaçlar ve gübrelerle karışabilir.
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                            Power Fe zirai ilaçlar ve gübrelerle karışabilir.
