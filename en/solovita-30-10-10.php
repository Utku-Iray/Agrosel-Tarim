...
<section class="service-details">
    <div class="container">
        <div class="row">
                                ...
                                <ul>
                                    ...
                                    <div id="in55" class="collapse" style="padding-left: 20px;">
                                        <ul>
                                            ...
                                            <li style="background-color: #e3e3e3;"><a href="solovita-30-10-10.php">Solovita 30-10-10</a></li>
                                        </ul>
                                    </div>
                                </ul>
                            </div>
            ...
            <div class="col-lg-8">
                <h2 style="margin-top: 0px;">Solovita 30-10-10 + TE</h2>
                <img src="../assets/images/pdf/solovita/30-10-10+te.jpeg" alt="">
                <h5>Solovita 30-10-10 + TE</h5>
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;"> Solovita 30-10-10 + TE; It is a 100% water soluble fertilizer containing high potassium.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/solovita/solovita-301010-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> 30-10-10 + TE Label</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/solovita/solovita-301010-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> 30-10-10 + TE Registration</span></a>
                        </div>
                    </div>
                </div>
