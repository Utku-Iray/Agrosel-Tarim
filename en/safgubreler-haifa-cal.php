        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <ul>
                                ...
                                <ul>
                                    ...
                                    <div id="in11" class="collapse" style="padding-left: 20px;">
                                        <ul>
                                            ...
                                            <li style="background-color: #e3e3e3;"><a href="safgubreler-haifa-cal.php">Haifa Cal</a></li>
                    ...
                    <div>
                        <a target="_blank" href="../assets/images/pdf/haifa-cal-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black">Haifa Cal Etiket</span> </a>
                    </div>
                    <br>
                    <div>
                        <a target="_blank" href="../assets/images/pdf/haifa-cal-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black"> Haifa Cal Tescil</span></a>
                    </div>
                </div><!-- /.service-sidebar -->
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-8">
                ...
                <h3 style="margin-top: 20px;">"Calcium Nitrate (15.5-0-0+26.5CaO) "</h3>
                <p>Haifa Cal is a highly efficient source of Calcium and Nitrogen for your plants. Calcium is a "quality nutritional element" that improves the quality of products and extends their shelf life. Since calcium is not mobile in the plant, it must be applied continuously throughout the growing season to keep it at a sufficient level in the plant tissues and to ensure proper development. Nitrate Nitrogen in Haifa Cal is easily absorbed by the plant and increases the efficiency of Calcium uptake.</p>
               
                <h5 style="margin-top: 20px;">Advantages of Haifa Cal Product</h5>
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;"> Does not contain sulfates.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/haifa-cal-etiket.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Haifa Cal Etiket</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/haifa-cal-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Haifa Cal Tescil</span></a>
                        </div>
                    </div>
                </div>
