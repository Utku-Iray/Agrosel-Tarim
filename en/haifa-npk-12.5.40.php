...
<head>
    ...
    <title>Haifa Multifeed 12-5-40 | Solube NPK Fertilizer | Agrosel Tarım  </title>
    <!-- favicons Icons -->
...
<hr>
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/muti-12.5.40-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">  12.5.40 + TE Registration</span></a>
                        </div>
                    </div>
                </div>
