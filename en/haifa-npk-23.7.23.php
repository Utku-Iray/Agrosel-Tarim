...
<head>
    ...
    <title>Haifa Multifeed 23-7-23 | Solube NPK Fertilizer | Agrosel Tarım</title>
    <!-- favicons Icons -->
            ...
            <div class="col-lg-8">
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/Multifeed-23.7.23-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> 23.7.23 Registration</span></a>
                        </div>
                    </div>
                </div>
