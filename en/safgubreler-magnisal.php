...
Concentration %</th>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a target="_blank" href="../assets/images/pdf/magnisal-tescil.pdf"><img src="../assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Magnisal Registration</span></a>
                        </div>
                    </div>
                </div>
