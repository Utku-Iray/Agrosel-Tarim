    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <h3 style="margin-top: 0px;">Terrafert Foliar 10-40-10 özel yaprak gübreleri</h3>
                <p> Bitkilerin vejetatif gelişme dönemlerinden başlayarak bitki türüne özgü özel formülasyonları sayesinde bitkilerin her 
döneminde ihtiyaç duyacağı gerekli besinleri en uygun şekilde sağlayan eşsiz bir NPK yaprak gübresidir. TERRAFERT FOLIAR özel yaprak gübreleri; yetiştiriciliğin 
zor olduğu olumsuz hava şartlarında dahi bitkilerin ek besin ihtiyaçlarını, geliştirilmiş teknolojileri sayesinde karşılamaya yardımcı olur.
                </p>
                <hr>
                <a href="#myModal" data-toggle="modal" data-target="#myModal"><img src="assets/images/terrafert-10-40-10-foliar1.jpeg" alt=""></a>

                <div id="myModal" class="modal fade" tabindex="-1" role="dialog">
                    <div class="modal-dialog" style="max-width:1000px !important">
                        <div class="modal-content">
                            <div class="modal-body">
                                <img src="assets/images/terrafert-10-40-10-foliar1.jpeg" class="img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
                <hr>
                <a href="#myModal2" data-toggle="modal" data-target="#myModal2"><img src="assets/images/terrafert-foliar2.jpeg" alt=""></a>

                <div id="myModal2" class="modal fade" tabindex="-1" role="dialog">
                    <div class="modal-dialog" style="max-width:1000px !important">
                        <div class="modal-content">
                            <div class="modal-body">
                                <img src="assets/images/terrafert-foliar2.jpeg.jpeg" class="img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <hr>
                <h5 style="margin-top: 20px;">Terrafert Foliar 10-40-10 Ambalaj:</h5>
                <div>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="assets/images/pdf/terrafert-foliar-10-40-10-etiket.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> Foliar 10-40-10 Etiket</span> </a>
                        </div>
                        <div class="col-md-6">
                            <a target="_blank" href="assets/images/pdf/terrafert-foliar-10-40-10-tescil.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Foliar 10-40-10 Tescil</span></a>
                        </div>
                    </div>
                </div>
