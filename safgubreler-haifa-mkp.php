        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="service-sidebar__links">
                                ...
                                <ul>
                                    ...
                                    <div id="in11" class="collapse">
                                        <ul>
                                            ...
                                            <li  style="background-color: #e3e3e3;"><a href="safgubreler-haifa-mkp.php">Haifa MKP</a></li>
                    ...
                    <div>
                        <a target="_blank" href="assets/images/pdf/haifa-mpk-etiket.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black">Haifa MKP Etiket</span> </a>
                    </div>
                    <br>
                    <div>
                        <a target="_blank" href="assets/images/pdf/haifa-mpk-tescil.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black">Haifa MKP Tescil</span></a>
                    </div>
                </div><!-- /.service-sidebar -->
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-8">
                ...
                <h5 style="margin-top: 20px;">Haifa MKPTM'nin Avantajları</h5>
                <div>
                ...
                <table class="table" style="margin-top: 20px;">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th scope="col"> Haifa MKPTM / 100 g su</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                ...
                <h5 style="margin-top: 25px;">Haifa MKPTM için pH ve EC Değerleri</h5>
                <table class="table" style="margin-top: 20px;">
                    <thead class="thead-dark">
                        <tr>
                            <th scope="col">#</th>
...
<p>*Not: Haifa MKPTM Kalsiyum veya Magnezyum gübreleriyle karıştırılmamalıdır.</p>
