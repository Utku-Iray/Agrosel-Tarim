        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="service-sidebar">
                        ...
                        <ul>
                            ...
                            <div id="in16" class="collapse">
                                <ul>
                                    ...
                                    <li  style="background-color: #e3e3e3;"><a href="jr-jacks-professional-most.php">Jack's Professional MOST</a></li>
                                </ul>
                            </div>
                    ...
                    <div>
                        <a target="_blank" href="assets/images/pdf/jacks-most-etiket.pdf"> <img src="assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black">Jack's Prof. Most Etiket</span> </a>
                    </div>
                    <br>
                    <div>
                        <a target="_blank" href="assets/images/pdf/jacks-most-tescil.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black">Jack's Prof. Most Tescil</span></a>
                    </div>
                </div><!-- /.service-sidebar -->
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-8">
