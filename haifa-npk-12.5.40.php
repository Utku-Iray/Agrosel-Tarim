        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="service-sidebar">
                            ...
                            <div id="in8" class="collapse">
                                <ul>
                                    ...
                                    <div id="in9" class="collapse">
                                        <ul>
                                            <li style="background-color: #e3e3e3;"><a href="">Multifeed 12.5.40+2MgO+ME</a></li>
                    ...
                    <div>
                        <a target="_blank" href="assets/images/pdf/muti-12.5.40-tescil.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black"> Multifeed 12.5.40 Etiket</span> </a>
                    </div>
                    <br>
                    <div>
                        <a target="_blank" href="assets/images/pdf/muti-12.5.40-tescil.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black"> Multifeed 12.5.40 Tescil</span></a>
                    </div>
                </div><!-- /.service-sidebar -->
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-8">
