...
<head>
    ...
    <title>Terrafert Progency | Sıvı NP Gübre Çözeltisi | Agrosel Tarım  </title>
    <!-- favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="assets/images/favicons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="assets/images/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="assets/images/favicons/favicon-16x16.png">
    <link rel="manifest" href="assets/images/favicons/site.webmanifest">
    <meta name="description" content="Terrafert Progency sıvı NP gübre çözeltisi yüksek oranda fosfor içeriği ile bitkilerin çiçeklenme ve meyvelenme dönemlerindeki gelişimine katkıda bulunur.">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <img src="assets/images/PROGENCY4.jpg" alt="">
                  <h3 style="margin-top: 0px;">Sıvı NP Gübre Çözeltisi 3-25-0 + 5 Zn + TE</h3>
                  <p>Terrafert Progency sıvı NP gübre çözeltisi yüksek oranda fosfor pentaoksit formülüne ek çinko ve iz element içeriği ile birlikte bitkilerin çiçeklenme ve meyvelenme dönemlerindeki gelişimine katkıda bulunur.</p><br>

<p>Bitkilerin çiçek açma ve çiçekten meyveye dönme dönemlerinde fosfor ihtiyaçları artar. Özellikle fotosentez ve kök gelişimi sırasında bitkinin artan fosfor ihtiyacını karşılayan Terrafert Progency sıvı NP gübre çözeltisi, bitkilerin ihtiyaç duyduğu enerjiyi optimum seviyede sağlar. </p><br>

<p>Verimli bir çiçeklenme dönemi için bitkilerde hücre bölünmesi ve yeni hücrelerin oluşmasını hızlandırır. Bitki köklerinin ve çiçeklerin sağlıklı ve kaliteli gelişmesine direkt etki eden ileri teknoloji ile elde edilmiş mükemmel bir sıvı NP gübre çözeltisidir. 
 </p>
                <hr>
                ...
                <hr>
                <h5 style="margin-top: 20px;">Terrafert Progency Ambalaj:</h5>
                <div>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="assets/images/pdf/PROGENCY-ETiKET.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Progency Etiket</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="assets/images/pdf/PROGENCY-TESCiL.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Progency Tescil</span></a>
                        </div>
                    </div>
                </div>
