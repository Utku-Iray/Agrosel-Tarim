        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <ul>
                    ...
                    <div>
                        <a target="_blank" href="assets/images/pdf/Haifa-UP-etiket.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black">Haifa UP Etiket</span> </a>
                    </div>
                    <br>
                    <div>
                        <a target="_blank" href="assets/images/pdf/Haifa-UP-tescil.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black">Haifa UP Tescil</span></a>
                    </div>
                </div><!-- /.service-sidebar -->
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-8">
                ...
                <p>Haifa UPTM, Tüm sebzeler ve meyve ağaçlarına yönelik NutrigationTM uygulaması için bir üre fosfattır. <br>
                    Haifa UPTM, gübre karışımlarının hazırlanması ve sıvı gübrelerin üretilmesi için uygundur.</p>
                ...
                <p>Not: Haifa UPTM , Kalsiyum veya Magnezyum gübreleriyle karıştırılmamalıdır.</p>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="assets/images/pdf/Haifa-UP-etiket.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Haifa UP Etiket</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="assets/images/pdf/Haifa-UP-tescil.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Haifa UP Tescil</span></a>
                        </div>
                    </div>
                </div>
