    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <h3 style="margin-top: 0px;">Terrafert Foliar 4-5-40 özel yaprak gübreleri</h3>
...
zor olduğu olumsuz hava şartlarında dahi bitkilerin ek besin ihtiyaçlarını, geliştirilmiş teknolojileri sayesinde karşılamaya yardımcı olur.
                ...
                <hr>
                <a href="#myModal" data-toggle="modal" data-target="#myModal"><img src="assets/images/terrafert-4-5-40-foliar1.jpeg" alt=""></a>

                <div id="myModal" class="modal fade" tabindex="-1" role="dialog">
                    <div class="modal-dialog" style="max-width:1000px !important">
                        <div class="modal-content">
                            <div class="modal-body">
                                <img src="assets/images/terrafert-4-5-40-foliar1.jpeg" class="img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <hr>
                <h5 style="margin-top: 20px;">Terrafert Foliar 4-5-40 Ambalaj:</h5>
                <div>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="assets/images/pdf/terrafert-foliar-4-5-40-etiket.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> Foliar 4-5-40 Etiket</span> </a>
                        </div>
                        <div class="col-md-6">
                            <a target="_blank" href="assets/images/pdf/terrafert-foliar-4-5-40-tescil.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Foliar 4-5-40 Tescil</span></a>
                        </div>
                    </div>
                </div>
