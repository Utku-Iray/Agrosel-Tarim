    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <h5 style="margin-top: 20px;">Solovita 15-30-15 + TE</h5>
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">Solovita 15-30-15 + TE; suda çözünebilen yüksek oranda potasyum ve azot, yeterli miktarda fosfor ve mikro element ihtiva eden bir üründür.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">Solovita 15-30-15 + TE seranızın ve tarlanızın verimini arttırır.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="assets/images/pdf/solovita/solovita-153015-etiket.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> 15-30-15 + TE Etiket</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="assets/images/pdf/solovita/solovita-153015-tescil.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> 15-30-15 + TE Tescil</span></a>
                        </div>
                    </div>
                </div>
