            ...
            <div class="col-lg-6">
                <div class="about-three__content">
                    ...
                    <!-- <ul class="about-three__list list-unstyled">
                        <li>
                            <i class="fa fa-check-circle"></i> Suspe ndisse suscipit sagittis
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i> If you are going to a passage
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i> Entum estibulum dignissim
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i> Entum estibulum dignissim
                        </li>
    ...
    <div class="container" style="margin-bottom: 50px;">
        ...
        <div class="col-xl-12">
            <div class="team-one__carousel-wrap">
                <div class="thm-swiper__slider swiper-container" style="left: 3%;" data-swiper-options='{"spaceBetween": 0, "slidesPerView": 1, "slidesPerGroup": 1, "autoplay": { "delay": 5000 }, "navigation": {
