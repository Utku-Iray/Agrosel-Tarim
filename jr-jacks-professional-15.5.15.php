        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="service-sidebar__links">
                        <ul>
                            ...
                            <div id="in16" class="collapse">
                                <ul>
                                    ...
                                    <li  style="background-color: #e3e3e3;"><a href="jr-jacks-professional-15.5.15.php">Jack's Professional 15.5.15+Ca+Mg</a></li>
                    ...
                    <div>
                        <a target="_blank" href="assets/images/pdf/jacks-prof-15.5.15-etiket.pdf"> <img src="assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black">Jack's Professional 15.5.15 Etiket</span> </a>
                    </div>
                    <br>
                    <div>
                        <a target="_blank" href="assets/images/pdf/jacks-prof-15.5.15-tescil.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="100px" alt=""><span style="font-weight: bold;color:black">Jack's Professional 15.5.15 Tescil</span></a>
                    </div>
                </div><!-- /.service-sidebar -->
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-8">
