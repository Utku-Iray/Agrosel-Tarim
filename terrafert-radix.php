    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <p>Her türlü toprak koşulunda, köklerde yeni ve emici kılcal saçaklarının oluşumunu teşvik eden, aynı zamanda köklerin uzamasını 
hızlandırarak daha fazla kök oluşmasını sağlayan ileri teknoloji ile elde edilmiş mükemmel bir üründür.
                </p>
                <hr>
                <a href="#myModal" data-toggle="modal" data-target="#myModal"><img src="assets/images/radix1.jpeg" alt=""></a>

                <div id="myModal" class="modal fade" tabindex="-1" role="dialog">
                    <div class="modal-dialog" style="max-width:1000px !important">
                        <div class="modal-content">
                            <div class="modal-body">
                                <img src="assets/images/radix1.jpeg" class="img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
                <hr>
                <a href="#myModal2" data-toggle="modal" data-target="#myModal2"><img src="assets/images/radix2.jpeg" alt=""></a>

                <div id="myModal2" class="modal fade" tabindex="-1" role="dialog">
                    <div class="modal-dialog" style="max-width:1000px !important">
                        <div class="modal-content">
                            <div class="modal-body">
                                <img src="assets/images/radix2.jpeg" class="img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <hr>
                <h5 style="margin-top: 20px;">Terrafert Radix Ambalaj:</h5>
                <div>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="assets/images/pdf/radix-etiket.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> Radix Etiket</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="assets/images/pdf/radix-tescil.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">Radix Tescil</span></a>
                        </div>
                    </div>
                </div>
