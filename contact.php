    ...
    <div class="container">
        <div class="row">
                    ...
                    <div class="contact-one__summery">
                        <ul class="mobile-nav__contact list-unstyled">
                            <li>
                                ...
                                <a style="color:black" href="mailto:agrosel@agroseltarim.com">agrosel@agroseltarim.com</a>
                            </li>
                            <li>
                                <i class="agrikon-icon-telephone"></i>
                                <a style="color:black" href="tel:0(242)313 16 26">0 (242) 313 16 26</a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-8">
                <form action="mail/mail.php" method="POST" class="contact-one__form ">
                    <div class="row">
                        <div class="col-lg-6">
