...
<section class="service-details">
    <div class="container">
        <div class="row">
                                   ...
                                   <li><a id="neovent" data-toggle="collapse" href="#in15" style="color:white;font-weight:bold;background-color:rgb(37, 89, 70,0.8)">Neovent ACF</a></li>
                                    ...
                                    <div id="in55" class="collapse" style="padding-left: 20px;">
                                        <ul>
                                            ...
                                            <li style="background-color: #e3e3e3;"><a href="solovita-16-8-24.php">Solovita 16-8-24</a></li>
            ...
            <div class="col-lg-8">
                <h2 style="margin-top: 0px;">Solovita 16-8-24 + TE</h2>
                <img src="assets/images/pdf/solovita/16-8-24+te.jpeg" alt="">
                <h5 style="margin-top: 20px;">Solovita 16-8-24 + TE</h5>
                <div>
                    <ul class="list-unstyled service-details__list-2">
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">Solovita 16-8-24 + TE; suda çözünebilen yüksek oranda potasyum ve azot, yeterli miktarda fosfor ve mikro element ihtiva eden bir üründür.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                        ...
                        <li>
                            <i class="fa fa-check-circle"></i>
                            <span style="font-weight: bold;">Solovita 16-8-24 + TE seranızın ve tarlanızın verimini arttırır.</span>
                        </li>
                        <li>
                            <i class="fa fa-check-circle"></i>
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="assets/images/pdf/solovita/solovita-16824-etiket.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> 16-8-24 + TE Etiket</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="assets/images/pdf/solovita/solovita-16824-tescil.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black"> 16-8-24 + TE Tescil</span></a>
                        </div>
                    </div>
                </div>
