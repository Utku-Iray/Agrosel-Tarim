        ...
        <div class="row">
                ...
                <ul>
                            ...
                            <div id="in16" class="collapse" style="padding-left: 20px;">
                                <ul>
                                    ...
                                    <li><a href="tribodyn-lithovit.php">Lithovit CO2</a></li>
                                    <li style="background-color: #e3e3e3;"><a href="chi-liquid.php">CHI-Liquid Humus 24</a></li>
                                </ul>
                            </div>
            ...
            <div class="col-lg-8">
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-md-6">
                            <a target="_blank" href="assets/images/pdf/liquid-etiket.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">CHI-Liquid Etiket</span> </a>
                        </div>

                        <div class="col-md-6">
                            <a target="_blank" href="assets/images/pdf/liquid-tescil.pdf"><img src="assets/images/pdf/pdf-icon-0.jpg" width="70px" alt=""><span style="font-weight: bold;color:black">CHI-Liquid Tescil</span></a>
                        </div>
                    </div>
                </div>
